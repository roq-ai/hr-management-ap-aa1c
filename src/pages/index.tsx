  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management Application - Your one-stop solution for efficient, seamless, and comprehensive human resource management needs. Streamline your HR processes with us."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application - Your one-stop solution for efficient, seamless, and comprehensive human resource management needs. Streamline your HR processes with us.`}
            </Text>
            <Box
